...
function addClient(event) {
    ...
    const existingClients = JSON.parse(localStorage.getItem('db_usss009122_usss014522_estudiante')) || [];
    ...
    localStorage.setItem('db_usss009122_usss014522_estudiante', JSON.stringify(existingClients));
  ...
  function displayClientsInTable() {
    ...
    const clients = JSON.parse(localStorage.getItem('db_usss009122_usss014522_estudiante')) || [];
  ...
  function updateClient(codigo) {
    ...
    localStorage.setItem('db_usss009122_usss014522_estudiante', JSON.stringify(updatedClients));
    displayClientsInTable();
  ...
  function deleteClient(codigo) {
    let clients = JSON.parse(localStorage.getItem('db_usss009122_usss014522_estudiante')) || [];
    clients = clients.filter(client => client.codigo !== codigo);
    localStorage.setItem('db_usss009122_usss014522_estudiante', JSON.stringify(clients));
    displayClientsInTable();
  }
